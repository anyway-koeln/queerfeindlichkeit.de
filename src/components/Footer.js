...
function Footer() {
  return (
    <footer className="body1">
      <a href="https://www.instagram.com/queerfeindlichkeit/">Instagram: @queerfeindlichkeit</a><br />
      <a href="https://twitter.com/anyway_koeln">Twitter: @anyway_koeln</a><br />
      <a href="https://github.com/anyway_koeln/">Source Code on GitHub</a><br />
      <br />
